...
# ======================================================
# 1) COMBINED FIGURE — THREE-TREATMENT NMDS
# Macro (Fig1_NMDS) + Bacteria (FigB2_NMDS)
# ======================================================

FigS2_nmds <- fig1_nmds / figB2_nmds +
  plot_annotation(
    title = "Supplementary Figure S2 — NMDS (Three-Treatment: Ambient / Low / High)",
    theme = theme(
...
ggsave(
  filename = "figures/FigS2_Combined_NMDS_threeTreat.png",
  plot = FigS2_nmds,
  width = 11,
  height = 10,
  dpi = 400,
...
# ======================================================
# 2) COMBINED FIGURE — SIX-TREATMENT NMDS
# Macro (FigS1_NMDS) + Bacteria (FigSB2_NMDS)
# ======================================================

FigSB2_nmds <- figS1_nmds / figSB2_nmds +
  plot_annotation(
    title = "Supplementary Figure SB2 — NMDS (Six-Treatment: ASAN–HSEN)",
    theme = theme(
      plot.title = element_text(size = 15, face = "bold", hjust = 0.0)
    )
  )
...
ggsave(
  filename = "figures/FigSB2_Combined_NMDS_sixTreat.png",
  plot = FigSB2_nmds,
  width = 11,
  height = 10,
  dpi = 400,
