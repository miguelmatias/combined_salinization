...
# ---------------------------------------------------------
# RESTRICTED PERMUTATIONS WITH SITE AS RANDOM BLOCK
# ---------------------------------------------------------
ctrl <- how(blocks = df_meta$site)

# ---------------------------------------------------------
# PERMANOVA (Type II)
# ---------------------------------------------------------
perm <- adonis2(
  bray ~ salinity + nutrients + salinity * nutrients,
  data = df_meta,
  permutations = ctrl,
  by = "margin"
)
...
save_table_docx(
  perm_df_clean,
  file = "tables/Table1_PERMANOVA.docx",
  title = "Table 1. PERMANOVA results",
  subtitle = "Effects of salinity and nutrients on community composition (permutations restricted within site)."
)
```
...
# --- Export dbRDA results table ---
tab_dbrda <- broom::tidy(anova(best, by = "terms", permutations = 999))
save_table_docx(
  tab_dbrda,
  "tables/Table3_dbRDA.docx",
  title = "Table 3. Distance-based redundancy analysis (dbRDA) results",
  subtitle = "dbRDA results showing environmental variables explaining community composition variation."
)
...
save_table_docx(tab_grp, "tables/Table5_Groups.docx",
                title = "Table 5. Mixed-effects model for top four taxonomic groups",
